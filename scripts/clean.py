...
from office.helpers import SLIDE_REL_TYPE, opc_target, rels_source_part, write_minidom_xml
...
def remove_orphaned_slides(unpacked_dir: Path) -> list[str]:
    ...
    if removed and pres_rels_path.exists():
        ...
        if changed:
            write_minidom_xml(pres_rels_path, rels_dom)
